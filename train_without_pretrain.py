...
model = ResidueEncoderDecoderModel.from_encoder_decoder_pretrained('models/residue-roberta', 'models/residue-roberta', tie_encoder_decoder=True)
...
for epoch in range(n_epoch):
    ...
    for idx in range(len(data_batches)):
        inputs = pad_sequence(data_batches[idx], target_batches[idx], tokenizer, USE_CUDA)
